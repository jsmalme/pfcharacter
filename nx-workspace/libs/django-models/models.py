...
class CombatInfo(models.Model):
    ...
    weapons = models.ManyToManyField(Weapon, blank=True, on_delete=models.CASCADE)
...
class Equipment(models.Model):
    ac_items = models.ManyToManyField(AcItem, on_delete=models.CASCADE, blank=True)
    gear = models.ManyToManyField(Gear, on_delete=models.CASCADE, blank=True)
    ...
    current_burden = models.CharField(blank=True, null=True)
...
class Spells(models.Model):
    ...
    stats = models.ManyToManyField(SpellStat, on_delete=models.CASCADE)
    spellList = models.ManyToManyField(Spell, on_delete=models.CASCADE, blank=True)
...
class Feats(models.Model):
    feats = models.ManyToManyField(Feat, on_delete=models.CASCADE, blank=True)
...
class SpecialAbilities(models.Model):
    specialAbilities = models.ManyToManyField(SpecialAbility, on_delete=models.CASCADE, blank=True)
